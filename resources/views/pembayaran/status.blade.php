  ...
  <div class="max-w-5xl mx-auto py-12 px-6 lg:px-8">
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg">
      ...
      <div class="text-lg text-gray-600 mb-6">
        ...
        @else
          <div class="bg-red-100 text-red-800 p-6 rounded-lg shadow mt-4">
            <h2 class="font-semibold text-lg">Pembayaran Gagal</h2>
            <p>Maaf, bukti transfer Anda tidak valid. Silakan coba lagi.</p>
          </div>
        @endif
      </div>
