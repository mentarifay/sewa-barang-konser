...
<head>
  ...
  <title>Detail Powerbank Xiaomi 10000mAh</title>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p class="text-gray-600 mb-6">
            Powerbank ringan dan praktis dengan kapasitas 10000mAh. Kondisi sangat baik, mendukung quick charge.
          </p>
          <p class="text-2xl font-bold text-blue-600 mb-6">Rp 20.000 / hari</p>
      ...
      <div class="mt-12">
        ...
        <div class="space-y-6">
          <div class="bg-gray-50 p-6 rounded-lg shadow">
            <p class="font-semibold text-gray-800">⭐ 5/5 - Rina</p>
            <p class="text-gray-600 mt-2">Kecil, ringan, gampang dibawa ke mana-mana. Recommended!</p>
          </div>
          <div class="bg-gray-50 p-6 rounded-lg shadow">
            <p class="font-semibold text-gray-800">⭐ 4/5 - Andi</p>
            <p class="text-gray-600 mt-2">Bagus banget, cuma kalau dipakai lama agak panas.</p>
          </div>
        </div>
      </div>
