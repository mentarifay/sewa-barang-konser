  ...
  <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div>
      ...
      <p class="text-gray-600 mb-4">
        Cocok untuk live streaming atau komunikasi selama konser.
      </p>
      <p class="text-2xl font-semibold text-blue-600 mb-6">Rp 70.000 / hari</p>
  ...
  <div class="max-w-6xl mx-auto px-4 mt-12">
    ...
    <div class="space-y-4">
      <div class="p-4 bg-white rounded shadow">
        <p class="font-semibold">Rara</p>
        <p class="text-gray-600">Baterai awet, cocok dipakai seharian.</p>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-6xl mx-auto px-4 mt-12">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
      ...
      <a href="/powerbank/1" class="block bg-white p-4 rounded shadow hover:shadow-lg">
        <img src="https://i.pinimg.com/736x/b5/8f/52/b58f52b9a0fca9b5e6e292d9fbbbe27e.jpg" class="h-40 w-full object-cover rounded mb-2">
