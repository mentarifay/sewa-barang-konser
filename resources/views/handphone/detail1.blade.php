...
<head>
  ...
  <title>Detail Samsung Galaxy S21</title>
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p class="text-2xl font-bold text-blue-600 mb-6">Rp 80.000 / hari</p>
      ...
      <div class="mt-12">
        ...
        <div class="space-y-6">
          <div class="bg-gray-50 p-6 rounded-lg shadow">
            <p class="font-semibold text-gray-800">⭐ 5/5 - Dina</p>
            <p class="text-gray-600 mt-2">HP mulus banget, performanya kencang. Cocok buat kerja & foto-foto.</p>
          </div>
          <div class="bg-gray-50 p-6 rounded-lg shadow">
            <p class="font-semibold text-gray-800">⭐ 4/5 - Rafi</p>
            <p class="text-gray-600 mt-2">Bagus, cuma agak berat kalau dipakai lama. Tapi overall oke.</p>
          </div>
        </div>
      </div>
